  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-xl overflow-hidden">
        ...
        {chaptersExpanded && (
          <div className="px-5 pb-4 border-t border-gray-800 space-y-3">
            {/* 搜索 */}
            ...
            {chaptersLoading ? (
              ...
              <div className="max-h-[400px] overflow-y-auto space-y-2">
                {chaptersList
                  ...
                  .map(ch => (
                  <div key={ch.chapter_number} className="bg-gray-800 rounded-lg overflow-hidden">
                    {/* 章节标题行 */}
                    <button
                    ...
                    >
                      ...
                      <span className={`text-xs px-1.5 py-0.5 rounded shrink-0 ${
                        ch.status === 'draft' ? 'bg-yellow-900/30 text-yellow-400' : 'bg-gray-700 text-gray-400'
                      }`}>
                      ...
                      <div className="px-4 pb-4 space-y-3 border-t border-gray-700">
                          ...
                          {editingChapter === ch.chapter_number ? (
                            <>
                              <button
                                ...
                                className="flex items-center gap-1 px-3 py-1.5 text-xs bg-green-600 hover:bg-green-700 rounded-lg transition"
                              >
                              ...
                              <button
                                ...
                                className="flex items-center gap-1 px-3 py-1.5 text-xs bg-gray-700 hover:bg-gray-600 rounded-lg transition"
                              >
                                <X className="w-3 h-3" />
                                取消
                              </button>
                        ...
                        {editingChapter === ch.chapter_number ? (
                          <textarea
                            ...
                            className="w-full bg-gray-900 border border-gray-700 rounded-lg p-3 text-sm leading-relaxed focus:outline-none focus:border-blue-500 resize-y min-h-[200px] max-h-[400px] overflow-y-auto whitespace-pre-wrap font-mono"
                          />
                        ) : (
                          <div className="bg-gray-900 rounded-lg p-3 max-h-64 overflow-y-auto whitespace-pre-wrap text-sm leading-relaxed text-gray-300">
                            {expandedContent || '（无内容）'}
                          </div>
                        )}
                      </div>
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-xl p-5">
        ...
        {!mode && !result && (
          <div className="grid grid-cols-2 gap-4">
            <button
              ...
              className="flex flex-col items-center gap-3 p-6 bg-gray-800 hover:bg-gray-750 border border-gray-700 hover:border-blue-500 rounded-xl transition group"
            >
              <Clipboard className="w-8 h-8 text-gray-500 group-hover:text-blue-400 transition" />
            ...
            <button
              ...
              className="flex flex-col items-center gap-3 p-6 bg-gray-800 hover:bg-gray-750 border border-gray-700 hover:border-purple-500 rounded-xl transition group"
            >
        ...
        {mode === 'paste' && !result && (
          <div className="space-y-3">
            ...
            <textarea
              ...
              rows={10}
              className="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-3 text-sm focus:outline-none focus:border-blue-500 resize-none font-mono"
            />
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="px-4 py-2 bg-blue-600 hover:bg-blue-700 disabled:opacity-40 rounded-lg text-sm transition"
              >
                预览拆分结果
              </button>
            </div>
        ...
        {previewChapters.length > 0 && !result && (
          <div className="mt-4 space-y-3">
            ...
            <div className="max-h-64 overflow-y-auto space-y-1 bg-gray-800 rounded-lg p-3">
            ...
            <div className="flex justify-end">
              <button
                ...
                disabled={loading}
                className="flex items-center gap-2 px-5 py-2 bg-green-600 hover:bg-green-700 disabled:opacity-50 rounded-lg text-sm transition"
              >
        ...
        {result && (
          <div className="mt-4 space-y-3">
              ...
              <div className="bg-blue-900/10 border border-blue-800/30 rounded-lg p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <div className="text-sm font-medium text-blue-300">建议：执行智能预处理</div>
            ...
            {preprocessStatus === 'running' && (
              <div className="bg-blue-900/10 border border-blue-800/30 rounded-lg p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-sm font-medium text-blue-300">正在预处理...</div>
            ...
            {preprocessStatus === 'done' && preprocessResult && (
              <div className="bg-green-900/10 border border-green-800/30 rounded-lg p-4 space-y-2">
                <div className="flex items-center gap-2 text-green-400">
            ...
            <button onClick={reset} className="text-xs text-blue-400 hover:underline">继续导入</button>
          </div>
        )}
